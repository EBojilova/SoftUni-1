    ...
    protected abstract class Animal
    {
        ...
        public string Name 
        {
            ...
            protected set
            {
                ...
                {
                    throw new ArgumentNullException("Name cannot be enpty.");
                }
                this.name = value;
            }
        }
        ...
        public int Age
        {
            ...
            private set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(string.Format("Age should be between {0} and {1}.", MinAnimalAge, MaxAnimalAge));
                }
                this.age = value;
            }
        }
